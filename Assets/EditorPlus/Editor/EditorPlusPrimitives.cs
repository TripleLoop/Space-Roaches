...
namespace EditorPlus
{
    public class EditorPlusPrimitives : EditorWindow
    {
        ...
        {
            UnityPrimitiveCubeThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Cube", typeof(Texture));
            UnityPrimitiveSphereThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Sphere", typeof(Texture));
            UnityPrimitiveCylinderThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Cylinder", typeof(Texture));
            UnityPrimitiveCapsuleThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Capsule", typeof(Texture));
            UnityPrimitivePlaneThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Plane", typeof(Texture));
            UnityPrimitiveQuadThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Quad", typeof(Texture));

            UnityPrimitivePointlightThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Pointlight", typeof(Texture));
            UnityPrimitiveArealightThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Arealight", typeof(Texture));
            UnityPrimitiveSunlightThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Sunlight", typeof(Texture));
            UnityPrimitiveSpotlightThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Spotlight", typeof(Texture));
            UnityPrimitiveReflectionprobeThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Reflectionprobe", typeof(Texture));
            UnityPrimitiveLightprobegroupThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Lightprobegroup", typeof(Texture));

            UnityPrimitiveParticlesystemThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Particlesystem", typeof(Texture));
            UnityPrimitiveAudioemitterThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Audioemitter", typeof(Texture));
            UnityPrimitiveAudioreverbThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Audioreverb", typeof(Texture));

            UnityPrimitiveCameraThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Camera", typeof(Texture));
            UnityPrimitiveCameraviewportThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Cameraviewport", typeof(Texture));
            UnityPrimitiveTreeThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Tree", typeof(Texture));
            UnityPrimitiveLandscapeThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Landscape", typeof(Texture));
            UnityPrimitiveSpriteThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Sprite", typeof(Texture));
            UnityPrimitiveNullobjectThumb = (Texture)Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlus_Icon_Nullobject", typeof(Texture));


            ButtonSize.x = UnityPrimitiveCubeThumb.width;
            ButtonSize.y = UnityPrimitiveCubeThumb.height;
            IconsSkin = Resources.Load(EditorPlus.SelectedSkinFolder + "UnityPlusSkinIcons") as GUISkin;
        ...
        void Unity5()
        {
            ...
            cnt.tooltip = "Cube";
            if (GUI.Button(EditorPlus.GetButtonRectByPos(ref posCur, ButtonSize, ButtonMargin, StartMargin, window), cnt))
            {
        ...
        void Unity4()
        {
            ...
            if (GUI.Button(EditorPlus.GetButtonRectByPos(ref posCur, ButtonSize, ButtonMargin, StartMargin, window), cnt))
            {
                EditorApplication.ExecuteMenuItem("Terrain/Create Terrain");
            }
